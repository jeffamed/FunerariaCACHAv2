    ...
    public function InfoDocumento(Request $request){
        ...
        if($tipoDoc == 'Contrato'){
            $informacion = Contrato::join('clientes as cl','contratos.idCliente','=','cl.id')
                               ->select('contratos.id',DB::raw('concat(cl.Nombre," ",cl.Apellido) as Cliente'),'contratos.cuota','contratos.Total','contratos.SaldoR')
            ...
            $informacion = Financiamiento::join('contratos as c','financiamientos.idContrato','=','c.id')
                                        ...
                                        -> select('financiamientos.id',DB::raw('concat(cl.Nombre," ",cl.Apellido) as Cliente'),'financiamientos.cuota','financiamientos.Total','financiamientos.SaldoR')
