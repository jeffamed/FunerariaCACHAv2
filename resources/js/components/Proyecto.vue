<template>
    <section class="main-section col-md-10 col-sm-12 d-flex ml-auto" id="SectionCuerpo">
        ...
        <!-- ENCABEZADO -->
            ...
            <!-- Boton nuevo -->
                <button class="btn-new"  @click="abrirModal('proyecto','registrar')" v-if="$can('proyecto.store')"><i class="hidden-xs-down fa fa-plus-circle"></i> Nuevo</button>
                <!-- Abrir Modal-->
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="">
                                    <div class="form-group">
                                        ...
                                        <!-- <small class="form-text text-muted">* Ingrese un Proyecto ejm.: Managua</small> -->
                                    </div>
                                    <div v-show="errorProyecto" class="form-group msjerror">
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-success" v-if="btnFuncion == 1" @click="registrarProyecto()"><i class="fa fa-check"></i> Guardar</button>
                                <button class="btn btn-success" v-if="btnFuncion == 2" @click="actualizarProyecto()"><i class="fa fa-check"></i> Actualizar</button>
                ...
                <div class="buscador d-flex ml-auto hidden-md-down">
                    ...
                    <input type="text" v-model="buscar" @keyup="mostrarProyecto(1,buscar,criterio)" class="buscar" placeholder="Buscar...">
            ...
            <div class="contenido__cuerpo" id="cuerpo-contenido">
                <div class="table-responsive tabla-contenido">
                    ...
                    <div class="form-inline mt-2 mb-2">
                        ...
                        <input type="text" id="txtbuscar" v-model="buscar" @keypress.enter="mostrarProyecto(1,buscar,criterio)" class="form-control hidden-lg-up mb-1 w-50" placeholder="Buscar...">
                    </div>
                    ...
                    <table class="tablesorter table table-striped table-hover table-sm" id="tabla">
                        ...
                        <tbody>
                            <tr v-for="proyecto in Proyectos" :key="proyecto.id" :style="proyecto.Estado=='Activo'?'':'color:red'">
                                <td>
                                    <button class="boton boton-edit" @click="abrirModal('proyecto','actualizar', proyecto)" v-if="$can('proyecto.update')"><i class="fa fa-pencil"></i></button>
                                    <template v-if="proyecto.Estado == 'Activo'">
                                        <button class="boton boton-eliminar" @click="desactivarProyecto(proyecto.id)" v-if="$can('proyecto.inactive')"><i class="fa fa-trash"></i></button>
                                    </template>
                                    <template v-else>
                                        <button class="boton boton-activar" @click="activarProyecto(proyecto.id)" v-if="$can('proyecto.active')"><i class="fa fa-check-circle"></i></button>
                                    </template>
                                </td>
...
<script>
    export default {
        ...
        methods:{
            mostrarProyecto(pagina,buscar,criterio){
                let me = this;
            ...
            activarProyecto(id){
                swal({
                    ...
                    reverseButtons: true,
                        ...
                        if (result.value) {
                            let me = this;
                            axios.put('/proyecto/activar', {'id' : id}).then(function(response) {
                                me.mostrarProyecto(1,'','Nombre');
                                swal(
                                    'Activado',
            ...
            desactivarProyecto(id){
                swal({
                    ...
                    reverseButtons: true,
                        ...
                        if (result.value) {
                            let me = this;
                            axios.put('/proyecto/desactivar', {'id' : id}).then(function(response) {
                                me.mostrarProyecto(1,'','Nombre');
                                swal(
                                    'Desactivado',
