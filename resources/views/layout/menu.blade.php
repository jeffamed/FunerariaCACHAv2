   ...
   <a class="bvmenu__item" href="#inicio" id="btnInicio" aria-expanded="false" aria-controls="inicio" data-toggle="collapse">
    ...
    <a class="bvmenu__item" href="#ubicacion" id="btnUbicacion" aria-expanded="false" aria-controls="ubicacion" data-toggle="collapse">
        ...
        <div class="collapse" id="ubicacion">
            <ul class="bvmenu__sub">
                <a class="bvmenu__subitem" href="#" @click="menu=4"><i class="fa fa-circle-o"></i>Barrios</a>
                <a class="bvmenu__subitem" href="#" @click="menu=5"><i class="fa fa-circle-o"></i>Zonas</a>
                <a class="bvmenu__subitem" href="#" @click="menu=6"><i class="fa fa-circle-o"></i>Departamentos</a>
                <a class="bvmenu__subitem" href="#" @click="menu=7"><i class="fa fa-circle-o"></i>Municipios</a>
            </ul>
        </div>
