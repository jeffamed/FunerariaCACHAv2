                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Agregar Opcion 1</h5>
           ...
           <div class="table-responsive tabla-contenido">
               ...
               <table class="tablesorter table table-striped table-hover table-sm" id="tabla">
                   ...
                   <tbody>
                       <tr>
                           <td>
                               <button class="boton boton-edit"><i class="fa fa-pencil"></i></button>
                               <button class="boton boton-eliminar"><i class="fa fa-remove"></i></button>
                            </td>
                            <td>Lucie Marvin</td>
