            ...
            <div class="row">
                ...
                <header class="barrah hidden-sm-down col-md-10 d-flex ml-auto">
                    <div class="col-md-5 barrah__encabezado1" v-if="menu >= 1 && menu <= 3 ">
                        <h5 class="barrah__titulo">Cartera <i class="fa fa-bank"></i></h5>
                    </div>
                    <div class="col-md-5 barrah__encabezado1" v-if="menu >= 4 && menu <= 6 ">
                        <h5 class="barrah__titulo">Catálogo <i class="fa fa-book"></i></h5>
                    </div>
                    <div class="col-md-5 barrah__encabezado1" v-if="menu >= 7 && menu <=10">
                        <h5 class="barrah__titulo">Ubicación <i class="fa fa-map"></i></h5>
                    </div>
                    <div class="col-md-5 barrah__encabezado1" v-if="menu == 11 || menu == 12">
                ...
                <!--  <div class="boxr"> </div> -->
                    ...
                    <div class="barrah__encabezado2 col-md-5 d-flex ml-auto justify-content-around">
                        ...
                        <h6 class="usuario"><span class="hidden-lg-down">Hola, Bienvenido</span> {{ Auth::user()->name }}</h6>
                        <a href="{{ route('logout') }}" class="Salir" data-toggle="tooltip" data-placement="bottom" title="Cerrar Sesión"
                ...
                <div class="barrav col-md-2 col-sm-12" id="barra-lateral">
                    <div class="bvencabezado d-flex" id="logo">
                        <img src="img/logo_48.png" alt="logo" class="bvencabezado__logo">
                ...
                <!-- CERRARA SESION DESDE LA CABECERA -->
                    <div class="bvsubmenu d-flex hidden-md-up">
                        <div class="bvsubmenu__cuerpo d-flex">
                            <h6 class="usuario"><i class="fa fa-user-circle"></i>{{ Auth::user()->name }}</h6>
                        ...
                        <div>
                            <a href="{{ route('logout') }}" class="Salir Salir--bv mr-3" 
